...
export class ScreenManager {
  ...
  constructor(app: CreationEngine, container: Container) {
    this.app = app;
  ...
  /** 更新 app 引用 */
  public setApp(app: CreationEngine): void {
    this.app = app;
  }
  ...
  public async addAndShowScreen(screen: AppScreen): Promise<void> {
  ...
  public getCurrentScreen(): AppScreen | undefined {
    return this.currentScreen;
  }

  public getCurrentPopup(): AppScreen | undefined {
    return this.currentPopup;
  }

  public getBackground(): AppScreen | undefined {
    return this.background;
  }
}

export type { AppScreen, AppScreenConstructor };
